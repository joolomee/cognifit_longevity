/* COGNIFIT LONGEVITY — Slater hybrid bundle: main.js (UI logic only)
   Runs after DOMContentLoaded because body is built natively in Webflow. */
(function(){
  function run(){
    try {
...
(function(){
  ...
  // Re-run if something dispatches cognifit:body-ready (e.g. CMS reload)
